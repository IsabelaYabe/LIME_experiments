  ...
  def load_datasets(self, dataset_names):
    ...
    for dataset in dataset_names:
         ...
         if result is None:
             ...
             continue  # Pula este dataset e continua com o próximo
         self.train_data[dataset], self.train_labels[dataset], self.test_data[dataset], self.test_labels[dataset], _ = result
